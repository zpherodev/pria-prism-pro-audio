          ...
          <TabsContent value="dynamics" className="space-y-6 pr-4">
            <div className="space-y-4 border border-gray-700 rounded-md p-3">
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[ratio]}
                  onValueChange={(values) => setRatio(values[0])}
                  min={1}
                  max={20}
                  step={0.1}
                />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[attack]}
                  onValueChange={(values) => setAttack(values[0])}
                  min={0.001}
                  max={0.5}
                  step={0.001}
                />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[release]}
                  onValueChange={(values) => setRelease(values[0])}
                  min={0.01}
                  max={2}
                  step={0.01}
                />
              ...
              <Button 
                ...
                onClick={() => handleApplyEffect('compressor')}
                disabled={!audioBuffer}
              >
                Apply Compressor
              </Button>
            ...
            <div className="space-y-4 border border-gray-700 rounded-md p-3">
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={(values) => setLimiterRelease(values[0])}
                  min={0.01}
                  max={1}
                  step={0.01}
                />
              ...
              <Button 
                size="sm"
                className="w-full mt-2" 
                onClick={() => handleApplyEffect('limiter')}
                disabled={!audioBuffer}
              >
                Apply Limiter
              </Button>
          ...
          <TabsContent value="effects" className="space-y-4 pr-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[flanger]}
                  onValueChange={(values) => setFlanger(values[0])}
                  min={0}
                  max={100}
                  step={1}
                />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[echo]}
                  onValueChange={(values) => setEcho(values[0])}
                  min={0}
                  max={100}
                  step={1}
                />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[distortion]}
                  onValueChange={(values) => setDistortion(values[0])}
                  min={0}
                  max={100}
                  step={1}
                />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[wahwah]}
                  onValueChange={(values) => setWahwah(values[0])}
                  min={0}
                  max={100}
                  step={1}
                />
            ...
            <div className="space-y-2 mt-4 border-t border-gray-700 pt-4">
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[timeStretch]}
                  onValueChange={(values) => setTimeStretch(values[0])}
                  min={0.5}
                  max={2}
                  step={0.01}
                />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  value={[pitchShift]}
                  onValueChange={(values) => setPitchShift(values[0])}
                  min={-12}
                  max={12}
                  step={1}
                />
            ...
            <Button 
              className="w-full mt-4" 
              onClick={() => handleApplyEffect('time and effects')}
              disabled={!audioBuffer}
            >
              Apply Effects
            </Button>
